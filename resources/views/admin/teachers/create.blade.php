    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">User baru akan otomatis diberi role Guru.</p>
            </div>
                        ...
                        <div class="card-body">
                            <form class="form" action="{{ route('teachers.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username" class="form-control @error('username') is-invalid @enderror"
                                                name="username" placeholder="Username Login" value="{{ old('username') }}">
                                            @error('username')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="password" id="confirm_password" class="form-control @error('confirm_password') is-invalid @enderror"
                                                name="confirm_password" placeholder="Ulangi Password">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="subjects">Mata Pelajaran yang Diajar</label>
                                            <select class="form-select select2" name="subjects[]" multiple="multiple">
